				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
						  ...
						  <ul class="pagination">
								<li><a href="staff.jsp#">Prev</a></li>
								<li class="active">
								  <a href="staff.jsp#">1</a>
								</li>
								<li><a href="staff.jsp#">2</a></li>
								<li><a href="staff.jsp#">3</a></li>
								<li><a href="staff.jsp#">4</a></li>
								<li><a href="staff.jsp#">5</a></li>
								<li><a href="staff.jsp#">Next</a></li>
							  </ul>
							</div>               
						</div>
					</div>
			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>业务员</strong></h2>
			            </div>
						<div class="panel-body">
							<form action="" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">业务员姓名</label>
				                    <div class="col-md-9">
				                        <input type="text" id="sname" name="sname" class="form-control" placeholder="业务员姓名">				                      
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">联系方式</label>
				                    <div class="col-md-9">
				                        <input type="text" id="stel" name="stel" class="form-control" placeholder="请输入电话号码">
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="email-input">电子邮箱</label>
				                    <div class="col-md-9">
				                        <input type="email" id="semail" name="semail" class="form-control" placeholder="请输入常用邮箱">
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">地址</label>
				                    <div class="col-md-9">
				                        <input type="text" id="saddress" name="saddress" class="form-control" placeholder="请输入地址">
				                    </div>
				                </div>
								<br>
				            </form>
						...
						<div class="panel-body">
							<form action="#" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">业务员姓名</label>
				                    <div class="col-md-9">
				                        <input type="text" id="sname" name="sname" class="form-control" placeholder="豆子">				                      
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">联系方式</label>
				                    <div class="col-md-9">
				                        <input type="text" id="stel" name="stel" class="form-control" placeholder="12345678910">
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="email-input">电子邮箱</label>
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">地址</label>
				                    <div class="col-md-9">
				                        <input type="text" id="saddress" name="saddress" class="form-control" placeholder="辽宁大连">
				                    </div>
				                </div>
								<br>
				            </form>
