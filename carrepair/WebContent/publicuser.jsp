	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href=publicuser.jsp# id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href=publicuser.jsp# id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
			</ul>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"><form>
							<h2><i class="fa fa-table red"></i><span class="break"></span><strong>普通客户管理</strong></h2>
						...
						<div class="panel-body">
							<table class="table table-hover">
							  ...
							  <tbody>								
								<tr>
									<td><input class="checkbox" type="checkbox" name="user"></td>
									<td>123456</td>
                                    <td>宝宝</td>
                                    <td>10987654321</td>
                                    <td>200</td>
						  ...
						  <ul class="pagination">
								<li><a href="publicuser.jsp#">Prev</a></li>
								<li class="active">
								  <a href="publicuser.jsp#">1</a>
								</li>
								<li><a href="publicuser.jsp#">2</a></li>
								<li><a href="publicuser.jsp#">3</a></li>
								<li><a href="publicuser.jsp#">4</a></li>
								<li><a href="publicuser.jsp#">5</a></li>
								<li><a href="publicuser.jsp#">Next</a></li>
							  </ul>               
						</div>
						</div>
					</div>
			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>普通用户</strong></h2>
			            </div>
						<div class="panel-body">
							<form action="" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="pname" name="pname" class="form-control" placeholder="客户姓名">				                      
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">联系方式</label>
				                    <div class="col-md-9">
				                        <input type="text" id="ptel" name="ptel" class="form-control" placeholder="请输入电话号码">
				                    </div>
				                </div>
				                <div class="form-group">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="premain" name="premain" class="form-control" placeholder="请输入首次充值金额">
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">地址</label>
				                    <div class="col-md-9">
				                        <input type="text" id="paddress" name="paddress" class="form-control" placeholder="请输入客户地址">
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">车牌号码</label>
				                    <div class="col-md-9">
				                        <input type="text" id="pcarnum" name="pcarnum" class="form-control" placeholder="请输入客户的车牌号码">
				                    </div>
				                </div>
								<br>
				            </form>
						...
						<div class="panel-body">
							<form action="#" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">客户姓名</label>
				                    <div class="col-md-9">
				                        <input type="text" id="pname" name="pname" class="form-control" placeholder="宝宝">				                      
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">联系方式</label>
				                    <div class="col-md-9">
				                        <input type="text" id="ptel" name="ptel" class="form-control" placeholder="10987654321">
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="email-input">电子邮箱</label>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="premain" name="premain" class="form-control" placeholder="2000">
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">地址</label>
				                    <div class="col-md-9">
				                        <input type="text" id="paddress" name="paddress" class="form-control" placeholder="山东潍坊">
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">车牌号码</label>
				                    <div class="col-md-9">
				                        <input type="text" id="pcarnum" name="pcarnum" class="form-control" placeholder="鲁E12345">
				                    </div>
				                </div>
								<br>
				            </form>
